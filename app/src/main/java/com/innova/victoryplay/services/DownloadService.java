...
public class DownloadService extends IntentService {
    ...
    private static final String DOWNLOAD_PATH = "com.innova.victoryplay.services.path";
    private static final String DESTINATION_PATH = "com.innova.victoryplay.services.destination";
